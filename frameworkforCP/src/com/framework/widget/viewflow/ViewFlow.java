...
public class ViewFlow extends AdapterView<Adapter> {
	...
	public ViewFlow(Context context, AttributeSet attrs) {
		...
		mSideBuffer = styledAttrs.getInt(R.styleable.fling_view_sidebuffer, 3);
		init();
	}
	...
	private void postViewSwitched(int direction) {
		...
		if (mViewSwitchListener != null && mCurrentBufferIndex < mLoadedViews.size()) {
			mViewSwitchListener.onSwitched(mLoadedViews.get(mCurrentBufferIndex), mCurrentAdapterIndex);
		}
		// logBuffer();
	}
	...
	//
	// EvtLog.d("viewflow", "Size of mLoadedViews: " + mLoadedViews.size() +
	// "X: " + mScroller.getCurrX() + ", Y: "
	// + mScroller.getCurrY());
	// EvtLog.d("viewflow", "IndexInAdapter: " + mCurrentAdapterIndex +
